Este projeto é apenas um design no FIGMA, desenvolvido em uma matéria da minha faculdade chamada Interface Humano-Computador. 
Foi elaborado por mim e meus colegas de faculdade, eu fiz cerca de 35% desse projeto.

segue o link para a visualização do projeto no FIGMA: 

https://www.figma.com/proto/DSVgijEMoYeDTXVlnVtF5r/4paws-(Copy)?type=design&node-id=554-873&t=KvUxoe6gcuQDj9TJ-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=302%3A227&show-proto-sidebar=1&mode=design


Pensamos em várias funções, aqui estão alguma delas (apenas ideias que colocamos no design):

Marcar atendimentos: Os usuários poderão marcar os atendimentos de seus pets, banhos, tosas, consultas etc.
